...
assert.match(loginPage, /<StaffGoogleLoginButton disabled=\{false\} onClick=\{handleGoogle\} \/>/)
assert.doesNotMatch(
...
assert.doesNotMatch(staffLoginService, /signInWithPopup/)
assert.doesNotMatch(staffLoginService, /shouldFallbackToRedirect/)
