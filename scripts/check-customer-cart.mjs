...
assert.match(customerMenuStyles, /\.customer-category-tabs__button--drink[\s\S]*border-left-color/)
assert.match(customerMenuStyles, /\.customer-category-tabs__button--food[\s\S]*border-left-color/)
