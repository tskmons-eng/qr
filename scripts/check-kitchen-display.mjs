...
assert.ok(kitchenItemRow.includes('getKitchenOrderActorLabel'), 'Kitchen row should resolve the visible order actor label')
assert.ok(kitchenItemRow.includes('orderedByStaffName'), 'Kitchen row should prefer staff member names over generic staff labels')
assert.ok(kitchenItemRow.includes('staff-kitchen-item__elapsed'), 'Kitchen row should render elapsed time as a distinct element')
...
assert.ok(kitchenCss.includes('display: inline-flex'), 'Kitchen option labels should sit inline with the product title')
...
assert.ok(kitchenCss.includes('.staff-kitchen-item__elapsed'), 'Kitchen elapsed time should have a higher-contrast chip')
assert.ok(kitchenCss.includes('color: #e5e7eb'), 'Kitchen elapsed time should be easier to read on the dark background')
